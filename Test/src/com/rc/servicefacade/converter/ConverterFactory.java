...
public class ConverterFactory {
	...
	static {
		...
		converterMap.put("wcs/v7/fep7/categoryview","com.rc.dto.wcs.v7.fep7.CategoryViewJSON"); //getCategoriesybyType
		System.out.println("Tagged6");
		
		converterMap.put("wcs/v7/fep7/guestidentity","com.rc.dto.wcs.v7.fep7.LoginViewJSON");
	...
	public static BaseConverterDTO getConverter(String actionName, BaseStoreConfigDTO configDTO) throws RCSystemException {
		...
		logger.info(METHOD_NAME+" : Enter getConverter");
		...
		logger.info(METHOD_NAME+" : Exit getConverter");
