...
import com.rc.ws.productapis.PromotionBasedRESTfulServices;

@Path("promo")
public class PromotionBasedRESTfulServicesImpl extends RESTFulBaseServiceImpl implements PromotionBasedRESTfulServices{
	...
	public String assignPromoCode() {
		...
		String METHOD_NAME = CLASS_NAME+"assignPromoCode()";
    	...
    	try {
    		...
    		serviceMap.put(Constants.SERVICE_NAME, Constants.ASSIGN_PROMO_CODE);
