...
import com.rc.ws.productapis.CheckoutBasedRESTfulServices;

@Path("checkout")
public class CheckoutBasedRESTfulServicesImpl extends RESTFulBaseServiceImpl implements CheckoutBasedRESTfulServices{
	
	@Autowired
    private RCDelegate mDelegate;

	public static String CLASS_NAME = CheckoutBasedRESTfulServicesImpl.class.getName();
    
    public final Logger logger = Logger.getLogger(CheckoutBasedRESTfulServicesImpl.class);

	public String getCheckoutProfile() {

		String METHOD_NAME = CLASS_NAME+"getCheckoutProfile()";
    	...
    	try {
    		...
    		serviceMap.put(Constants.SERVICE_NAME, Constants.GET_CHECKOUT_PROFILE);
